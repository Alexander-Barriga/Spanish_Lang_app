...
BEGIN
    ...
    (arc_id, 1, 'Café Tortoni - First Encounter', '', 'Tu primer encuentro con Florencia en el histórico Café Tortoni de Buenos Aires', 'present_subjunctive_formation', ARRAY['Quiero que', 'Es importante que', 'Espero que', 'Es necesario que'],
    ...
    INSERT INTO public.episodes (story_arc_id, episode_number, title_es, title_en, scenario, grammar_focus, grammar_triggers, scenes, journal_prompt_es, journal_prompt_en, estimated_duration) VALUES
    (arc_id, 2, 'Milonga en Salón Marabú - First Tango', '', 'Tu primera experiencia en una milonga tradicional de San Telmo con Florencia', 'subjunctive_emotions', ARRAY['Me alegra que', 'Es triste que', 'Me sorprende que', 'Me encanta que'],
    ...
    INSERT INTO public.episodes (story_arc_id, episode_number, title_es, title_en, scenario, grammar_focus, grammar_triggers, scenes, journal_prompt_es, journal_prompt_en, estimated_duration) VALUES
    (arc_id, 3, 'San Telmo Market - Colors and Secrets', '', 'Explorás el famoso mercado de antigüedades de San Telmo con Florencia', 'subjunctive_doubt', ARRAY['No creo que', 'Dudo que', 'Es posible que', 'No es seguro que'],
    ...
    INSERT INTO public.episodes (story_arc_id, episode_number, title_es, title_en, scenario, grammar_focus, grammar_triggers, scenes, journal_prompt_es, journal_prompt_en, estimated_duration) VALUES
    (arc_id, 4, 'Family Asado - Entering the Circle', '', 'Florencia te invita a un asado dominical con su madre Elena', 'subjunctive_desires', ARRAY['Quiero que', 'Prefiero que', 'Necesito que', 'Me gustaría que'],
    ...
    INSERT INTO public.episodes (story_arc_id, episode_number, title_es, title_en, scenario, grammar_focus, grammar_triggers, scenes, journal_prompt_es, journal_prompt_en, estimated_duration) VALUES
    (arc_id, 5, 'Cementerio de la Chacarita - The Truth About Valentina', '', 'Un paseo por el cementerio más famoso de Buenos Aires con reflexiones sobre la historia argentina', 'preterite_vs_imperfect', ARRAY['Cuando era', 'Mientras', 'De repente', 'Todos los días'],
    ...
    INSERT INTO public.episodes (story_arc_id, episode_number, title_es, title_en, scenario, grammar_focus, grammar_triggers, scenes, journal_prompt_es, journal_prompt_en, estimated_duration) VALUES
    (arc_id, 6, 'Teatro Colón - The Artist Revealed', '', 'Una conversación profunda sobre los desafíos de la vida en Argentina', 'imperfect_subjunctive', ARRAY['Si tuviera', 'Si pudiera', 'Quisiera que', 'Como si fuera'],
    ...
    INSERT INTO public.episodes (story_arc_id, episode_number, title_es, title_en, scenario, grammar_focus, grammar_triggers, scenes, journal_prompt_es, journal_prompt_en, estimated_duration) VALUES
    (arc_id, 7, 'La Boca - Beauty Born from Necessity', '', 'Explorando el barrio más colorido de Buenos Aires y el estadio de Boca Juniors', 'conditional_tense', ARRAY['Me gustaría', 'Podría', 'Sería', 'Tendría que'],
    ...
    INSERT INTO public.episodes (story_arc_id, episode_number, title_es, title_en, scenario, grammar_focus, grammar_triggers, scenes, journal_prompt_es, journal_prompt_en, estimated_duration) VALUES
    (arc_id, 8, 'Cafe Tortoni - Soñemos', '', 'Tu último encuentro con Florencia en la terraza de su edificio con vista a Buenos Aires', 'comprehensive_review', ARRAY['Espero que', 'Me alegra que', 'Si pudiera', 'Me gustaría que'],
